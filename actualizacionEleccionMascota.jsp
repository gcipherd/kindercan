...
<body>
	...
	<main>
		...
		<div id="seleccionarPerro"><br>
			<center><h1>Por favor, selecciona a la mascota a editar </h1></center>
			<br>
			<!-- Se crea un formulario para mostrar una lista de dueños-->
			<div>
				<form class="formulario container" action="modificarMascota.jsp" method="POST">
					...
					<br><br>
					<input id="registrar" class="btn btn-outline-success" type="submit" value="¡Actualizar datos!">
				</form>
			</div>
