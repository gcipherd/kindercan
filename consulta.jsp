	...
	<main>
		...
		<div class="menuRegistrando border">
			<ul class="nav nav-pills flex-column">
			  ...
			  <li class="nav-item">
			    <a class="nav-link active" href="#">Consultar mascota</a>
			  </li>
			  <li class="nav-item">
			    <a class="nav-link sobre" href="actualizacion.jsp">Actulizar datos</a>
			  </li>
			</ul>
		...
		<div id="seleccionarDueno"><br>
			<center><h1>Por favor, selecciona la mascota deseada...</h1></center>
			<br>
			<!-- Se crea un formulario para mostrar una lista de dueños-->
			<div>
				<form class="formulario container" action="mostrarMascotas.jsp" method="POST">
					<!-- Lista de dueños registrados en la BD -->
					<select name="perro">
						<option disabled selected>Elija la mascota</option>
						<%
							try {
					...
					<br><br>
					<input id="registrar" class="btn btn-outline-success" type="submit" value="¡Consultar datos!">
				</form>
			</div>
