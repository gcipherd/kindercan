...
<body>
	...
	<main>
		...
		<!-- Inician botones -->
		<a class="enlace" href="registroMascota.jsp">
			<button type="button" class="btn btn-lg btn-block font-weight-bold" id="botonRegistrando1">Registrar mascota<br>🐶</button>
		</a>

		<a class="enlace" href="registroEstancia.jsp">
			<button type="button" class="btn btn-lg btn-block font-weight-bold" id="botonRegistrando2">Registrar estancia<br>🏣</button>
		</a>
		<!-- Terminan botones -->
	</main>
