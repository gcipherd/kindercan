...
<%
		...
		//Se realiza la actualización de la tabla "dueno" de la BD
		try {
	        ...
	        int res = stmt.executeUpdate("UPDATE dueno SET nombre = '" + nombreDueno + "', apellidoPaterno = '" + apellidoPaterno + "', apellidoMaterno = '" + apellidoMaterno + "', delegacion = '" + delegacion + "', codigoPostal = '" + codigoPostal + "', calle = '" + calle + "', numExterior = '" + numeroExterior + "', numInterior = '" + numeroInterior + "', telefono = '" + telefono + "' WHERE idDueno = " + idDueno);
